...
#ifndef SEEKTHERMAL_AAA_USB_CONFIG_RECEIVE_X36_H
#define SEEKTHERMAL_AAA_USB_CONFIG_RECEIVE_X36_H

/** \brief Seek XX-AAA Thermal camera config receive request "0x36"
  *   (USB protocol)
  * 
