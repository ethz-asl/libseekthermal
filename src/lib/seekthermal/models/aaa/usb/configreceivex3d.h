...
#ifndef SEEKTHERMAL_AAA_USB_CONFIG_RECEIVE_X3D_H
#define SEEKTHERMAL_AAA_USB_CONFIG_RECEIVE_X3D_H

/** \brief Seek XX-AAA Thermal camera config receive request "0x3D"
  *   (USB protocol)
  * 
